...
export function Footer() {
  return (
    <footer className="border-t border-glass-border pt-16 pb-8 mt-32 relative z-10 bg-[#020202]">
      ...
      <div className="container mx-auto px-6 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center text-xs text-white/40 font-mono">
