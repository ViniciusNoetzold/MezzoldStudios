...
export function ContactCard({
	...
	return (
		<div
			...
			{...props}
		>
			<PlusIcon className="absolute -top-3 -left-3 h-6 w-6 text-white/50" />
			<PlusIcon className="absolute -top-3 -right-3 h-6 w-6 text-white/50" />
			<PlusIcon className="absolute -bottom-3 -left-3 h-6 w-6 text-white/50" />
			<PlusIcon className="absolute -right-3 -bottom-3 h-6 w-6 text-white/50" />
			...
			<div
				className={cn(
					'bg-[#020202]/50 flex h-full w-full items-center border-t border-white/10 p-5 md:col-span-1 md:border-t-0 md:border-l',
					formSectionClassName,
				)}
			>
				{children}
