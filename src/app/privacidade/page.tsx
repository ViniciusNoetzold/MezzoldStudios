...
export default function PrivacidadePage() {
  return (
    <main className="min-h-screen bg-[#020202] text-white selection:bg-electric-red/30 flex flex-col justify-between">
      <Header />
      
      <div className="flex-1 pt-40 pb-24 px-6 md:px-12 max-w-4xl mx-auto w-full">
        <h1 className="font-sans text-4xl md:text-5xl font-black tracking-tight mb-4 text-white">
          Política de Privacidade
        </h1>
        
        <div className="w-16 h-1 bg-electric-red mb-12"></div>

        <div className="space-y-10 text-white/60 leading-relaxed font-sans text-sm md:text-base">
          <div>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-bold tracking-tight text-white mb-4">1. Coleta de Dados</h2>
            <p className="mb-4">
            ...
            <ul className="list-none space-y-3">
              <li className="flex gap-2">
                ...
                <span><strong className="text-white">Informações de Contato:</strong> Captamos nome, e-mail e demais dados submetidos de modo voluntário por você nos formulários de interesse e nas interações diretas com as nossas interfaces de comunicação.</span>
              </li>
              <li className="flex gap-2">
                <span className="text-electric-red">›</span> 
                <span><strong className="text-white">Dados Operacionais e Tecnológicos:</strong> Informações de metadados, endereço IP e métricas analíticas anonimizadas de UX para garantir que nossas plataformas estejam escalando com máxima performance e segurança.</span>
              </li>
            </ul>
          </section>

          <section>
            <h2 className="text-xl md:text-2xl font-bold tracking-tight text-white mb-4">2. Como os Dados São Utilizados</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-bold tracking-tight text-white mb-4">3. Sigilo e Compartilhamento</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-bold tracking-tight text-white mb-4">4. Direitos e Gerenciamento de Dados</h2>
            <p className="mb-4">
